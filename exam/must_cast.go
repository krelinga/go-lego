...
// MustCast attempts to cast inVal value to the Out type. If the cast is successful, it returns the
// casted value. If the cast fails, it reports a fatal error using the provided testing interface,
// including information about the expected and actual types, as well as the context of the
// assertion.
