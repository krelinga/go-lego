...
// MapEqualFunc checks if two maps are equal by comparing their keys and values using a custom
// equality function. The eq parameter should be a function that takes two values of type U (where V
// is assignable to U) and returns a bool indicating whether they are considered equal.
...
// SliceEqualFunc checks if two slices are equal by comparing their elements using a custom equality
// function. The eq parameter should be a function that takes two values of type U (where V is
// assignable to U) and returns a bool indicating whether they are considered equal.
