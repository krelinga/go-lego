...
type FixedPair[K comparable, V any] interface {
	GetKey() K
	GetValue() V
}
...
func ViewPair[P FixedPair[K, V1], K comparable, V1 Viewer[V2], V2 any](p P) FixedPair[K, V2] {
...
type pairView[P FixedPair[K, V1], K comparable, V1 Viewer[V2], V2 any] struct {
	p P
}
...
func DeepCopyPair[P FixedPair[K, V], K comparable, V DeepCopier[V]](p P) Pair[K, V] {
